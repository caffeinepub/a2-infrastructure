...
export default function Footer() {
  ...
  return (
    <footer className="section-navy-deep border-t border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/55 text-sm leading-relaxed max-w-sm mt-4">
              A specialized civil engineering and infrastructure drafting firm
              committed to delivering precise, execution-ready engineering
              documentation from concept to completion.
            </p>
            ...
            <div className="flex items-center gap-3 mt-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-sm border border-white/15 flex items-center justify-center text-white/50 hover:text-gold hover:border-gold/50 hover:bg-white/5 transition-all duration-200"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-display font-700 text-sm tracking-widest uppercase mb-5">
              Quick Links
            </h4>
            ...
            <ul className="space-y-3.5">
              <li className="flex items-start gap-2.5">
                ...
                <a
                  ...
                  className="text-white/55 hover:text-gold text-sm transition-colors break-all"
                >
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-xs">
            © {year} A2 Infrastructure. All rights reserved.
          </p>
          <a
